...
const LegoSection = () => {
    return (
        <>
            <div className="container is-margin-top-5">
                <div className="container__row">
                    <div className="container__col-sm-4 text-align-center">
                        <img src={LegoYannisFront} alt="lego-icon-front"/>
                        <h2 className="text-align-center is-background-blue-text is-padding-bottom-2">Front-End</h2>
                    </div>
                    <div className="container__col-sm-4 text-align-center">
                        <img src={LegoYannisBack} alt="lego-icon-back"/>    
                        <h2 className="text-align-center is-background-blue-text is-padding-bottom-2">Back-End</h2>
                    </div>
                    <div className="container__col-sm-4 text-align-center">
                        <img src={LegoYannisFullStack} alt="stacked-lego-heads"/>
                        <h2 className="text-align-center is-background-blue-text is-padding-bottom-2 is-margin-bottom-0">Full-Stack</h2>
                    </div>
                </div>  
            </div>
        </>
