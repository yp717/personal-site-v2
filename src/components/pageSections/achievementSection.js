        ...
        <>
            ...
            <div className="container__row">
                ...
                <div className="container__col-sm-12 is-white-bg experience-card">
                    ...
                    <p className="is-background-blue-text body-text">
                ...
                <div className="container__col-sm-12 is-white-bg experience-card">
                    <h2 className="is-dark-grey-text">Old Centralian Trust Scholarship</h2>
                    <h3 className="is-dark-grey-text">Achievement Date</h3>
                    <p className="is-dark-grey-text body-text">
                ...
                <div className="container__col-sm-12 is-white-bg experience-card">
                    <h2 className="is-dark-grey-text">Gulf Finance House Leadership Award</h2>
                    <h3 className="is-dark-grey-text">Achievement Date</h3>
                    <p className="is-dark-grey-text body-text">
